...
現在、本プロジェクトは開発中のため、**プルリクエストは受け付けておりません**。

ただし、バグ報告やご意見・ご要望は受け付けています！ [Issue](../../issues) から作成してください。

## 💖 スポンサー

このプロジェクトを気に入っていただけましたら、[GitHub Sponsors](../../sponsor) でのご支援をご検討ください。いただいたご支援は、コーディング・ドキュメント作成の時間確保や、開発環境・AI ツールの維持に活用させていただきます。
